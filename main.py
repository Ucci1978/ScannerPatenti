...
menu = ["🏁 Inizio controllo", "📝 Inserimento dati", "📊 Report di fine turno"]
scelta = st.sidebar.radio("Navigazione", menu)

if scelta == "🏁 Inizio controllo":
    st.session_state.pagina = "inizio"
    st.title("🏁 Inizio controllo")
    st.info("Puoi iniziare un nuovo turno di controllo da qui.")

elif scelta == "📝 Inserimento dati":
    st.session_state.pagina = "inserimento"
    st.title("📝 Inserimento Dati da Patente")
...
elif scelta == "📊 Report di fine turno":
    st.session_state.pagina = "report"
    st.title("📊 Report di Fine Turno")
